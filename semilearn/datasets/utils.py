...
def get_collactor(args, net):
    ...
    elif net == 'flan_t5_base':
        from semilearn.datasets.collactors import get_flan_t5_base_collactor
        collact_fn = get_flan_t5_base_collactor(args.max_length, args.prefix)
