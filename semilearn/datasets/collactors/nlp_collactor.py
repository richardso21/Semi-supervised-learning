            ...
            if len(s_features) > 0:
                ...
                if len(s_features_) > 0:
                    ...
                    return {
                        ...
                        "x_ulb_s_1": {
                            "input_ids": s_batch_["input_ids"],
                            "attention_mask": s_batch_["attention_mask"],
                        },
                    }
                else:
                    return {
...
def get_roberta_base_sentiment_collactor(max_length=512):
...
def get_llama_8b_collactor(max_length=512):
